...
var d_mod = 0;
if (d_mod == 0) {
    router.get('http://localhost/project-hospital/satun-hospital-v4/public/home');
    // router.get('http://localhost/project-hospital/satun-hospital-v4_deploy/home');
    // console.log('y');
} else {
    // console.log('n');
}
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Documentationsss</h2>
