    ...
    <div>
      <div>
        ...
        >
          ...
          >
            สร้าง ตารางแพทย์ออกตรวจ
          </h5>
          <p class="font-normal text-gray-700 dark:text-gray-400">
            ตรวจสอบข้อมูลทุกครั้งก่อนบันทึก
          </p>
        </div>
      </div>
      <div class="mt-5">
              ...
              >
                ...
                >
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3">หัวข้อหลัก (ภาษาไทย)</th>
                    <th scope="col" class="px-6 py-3">หัวข้อหลัก (ภาษาอังกฤษ)</th>
                    <th scope="col" class="px-6 py-3">สร้างเมื่อ</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                    v-for="(doctor_table_section, index) in doctor_table_sections"
                    :key="doctor_table_section.id"
                  ...
                  >
                    ...
                    >
                      {{ doctor_table_section.name_th }}
                    </th>
                    <td class="px-6 py-4">{{ doctor_table_section.name_en }}</td>
                    <td class="px-6 py-4">{{ doctor_table_section.create_date }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
const selectSe = () => {
  formSubSection.name_select = props.doctor_table_sections[formSubSection.key].name_th;
  // formSubSection.name = props.ita_sections[formSubSection.key].name;
  formSubSection.doctor_table_section_id =
    props.doctor_table_sections[formSubSection.key].id;
};

const submit = () => {
  console.log(formSection.name_th, formSection.name_en);
  if (formSection.name != "") {
    formSection.post(route("Manage.MDoctorTable_create_insert"), {});
    formSection.name_th = "";
    formSection.name_en = "";
...
const submit_ita = () => {
  if (
    formSubSection.doctor_table_section_id != "" &&
    formSubSection.name_th != "" &&
    formSubSection.name_en != "" &&
    formSubSection.files != null
  ) {
    formSubSection.post(route("Manage.MDoctorTable_sub_create_insert"), {});
  ...
  //   console.log(formSubSection.name, formSubSection.year, formSubSection.detail, formSubSection.doctor_table_section_id,formSubSection.files);
};
