        ...
        <div class="mb-4 rounded bg-gray-50 dark:bg-gray-800">
          <div class="relative p-3 overflow-x-auto shadow-md sm:rounded-lg">
              ...
              <div class="container mx-auto">
                ...
                <div class="mt-4">
                  <div class="grid grid-cols-1 gap-5 md:grid-cols-5">
                    <div
                      class="w-full h-100"
                      data-modal-target="default-modal-banner"
                      data-modal-toggle="default-modal-banner"
                    >
                      <div class="w-full text-center h-100">
                        <div
                          class="block max-w-sm p-6 border border-gray-200 rounded-lg shadow bg-slate-200 dark:bg-gray-800 dark:border-gray-700"
                        >
                          <center class="mt-8">
                            <svg
                    ...
                    <div class="w-full h-100">
                      <div class="w-full text-center h-100">
                        ...
                        >
                          ...
                          >
                            <div class="absolute top-0 right-0 flex cursor-pointer">
                              <svg
            ...
            <section>
              ...
              <footer class="mt-8 bg-sky-950 dark:bg-gray-900">
                <div class="w-full py-6 mx-auto max-w-screen-2xl lg:py-8">
                  <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                      <div>
                        ...
                        <ul class="font-medium text-cyan-300 dark:text-gray-400">
                          <li class="mb-4">
                            <div class="flex">
                              Phone : 074 723 500
                              <svg
                                class="w-6 h-6 ml-2 text-white dark:text-white"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                      ...
                      <div>
                        ...
                        <ul class="font-medium text-cyan-300 dark:text-gray-400">
                          <li class="flex mb-4">
                            <a
                              href="#"
                              class="text-cyan-300 hover:text-gray-900 dark:hover:text-white"
                            >
                              <svg
                                class="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <ul class="font-medium text-cyan-300 dark:text-gray-400">
                          <li class="flex mb-4">
                            ...
                            <a href="#" class="flex ml-2"
                              >: โรงพยาบาล. ที่อยู่. 55/1 <br />ถนนหัตถกรรมศึกษา<br />
                              ตำบลพิมาน <br />อำเภอเมืองสตูล <br />จังหวัดสตูล 91000
                              <svg
                                class="w-6 h-6 ml-2 text-white dark:text-white"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
                      >© สงวนลิขสิทธิ์ 2024 | โรงพยาบาลสตูล สำนักงานปลัดกระทรวงสาธารณสุข
                    </span>
          ...
          <form novalidate @submit.prevent="submit">
            <div class="p-4 space-y-4 md:p-5">
              <label
                ...
                >{{ formEditGeneral.name_th }}</label
              >
              <input
                v-model="formEditGeneral.quantity"
                type="text"
                id="first_name"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            ...
            <button
              type="button"
              class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-gray-200 hover:text-gray-900 ms-auto dark:hover:bg-gray-600 dark:hover:text-white"
              data-modal-hide="default-modal-banner"
            >
              <svg
                class="w-3 h-3"
                aria-hidden="true"
          ...
          <!-- Modal body -->
          <form novalidate @submit.prevent="submit_banner">
            <div class="p-4 space-y-4 md:p-5">
              <label
                for="first_name"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
              ...
              >
              <input
                @input="form.News_title_image = $event.target.files[0]"
                @change="onFileChange"
              ...
              <div v-if="imgviwe.url" class="p-2 border-sky-500">
                <img v-if="imgviwe.url" class="w-full mt-2 border-2" :src="imgviwe.url" />
              </div>
            </div>
            <!-- Modal footer -->
            <div
              class="flex items-center p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600"
            >
              <PrimaryButton data-modal-hide="default-modal-banner" class="">
                + เพิ่ม
              </PrimaryButton>
              <button
                data-modal-hide="default-modal-banner"
...
const EditGeneral = (id, quantity, name) => {
  formEditGeneral.id = id;
  formEditGeneral.quantity = quantity;
  formEditGeneral.name_th = name;
};

const submit = () => {
  formEditGeneral.post(route("Manage.MGeneral_edit"), {});
...
const submit_banner = () => {
  form.post(route("Manage.MGeneral_banner_create"), {});
